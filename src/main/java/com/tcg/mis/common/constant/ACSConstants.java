...
public class ACSConstants {
	...
	public static final List<Integer> TCG_CREDIT_LIST = Lists.newArrayList(TCG_C_DEPOSIT);
    public static final List<Integer> TCG_DEBIT_LIST = Lists.newArrayList(TCG_D_WITHDRAW,TCG_D_DEPOSIT_CHARGE,TCG_D_WITHDRAW_FEE);
    //MANUAL_REJECT
    public static final List<Integer> PRODUCT_WALLET_MANUAL_ACCOUNT_TYPES = Lists.newArrayList(GameAccountType.IBC.getValue(),GameAccountType.MG.getValue(),GameAccountType.KY.getValue());
